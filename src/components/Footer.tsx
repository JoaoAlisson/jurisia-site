      ...
      <div className="max-w-[1200px] mx-auto px-5 lg:px-8">
        <div className="py-16 md:py-20 grid grid-cols-2 md:grid-cols-12 gap-10 md:gap-8">
          <div className="col-span-2 md:col-span-4">
            <div className="flex items-center gap-0.5 mb-5 select-none">
              <span className="text-lg font-black tracking-tighter text-slate-900 dark:text-white opacity-80">Juris</span>
              <span className="text-[9px] font-bold tracking-wide text-white bg-[#0A2540] dark:bg-blue-500 px-1.5 py-0.5 rounded ml-1 leading-none opacity-80">IA</span>
            </div>
