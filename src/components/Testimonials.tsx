...
const testimonials = [
  { quote: "Antes do JurisGPT, minha equipe perdia quase 15 horas por semana apenas checando os andamentos no e-SAJ e PJe. Hoje, a IA nos avisa apenas do que importa. O Radar de Oportunidades já nos trouxe dois novos clientes este mês.", name: "Ricardo Mendes", title: "Sócio Fundador", org: "OAB/SP", avatar: "/avatar-1.png" },
